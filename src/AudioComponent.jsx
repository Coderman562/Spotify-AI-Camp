...
export default function AudioComponent({ previewUrl, spotifyUrl, imageUrl }) {
    ...
    <div className="w-full">
      ...
      <div className="flex items-center justify-center h-screen bg-red-100">
        <div className="bg-white shadow-lg rounded-lg" style={{ width: "45rem" }}>
          <div className="flex">
            <div>
              <img className="w-full rounded hidden md:block" src={imageUrl} alt="Album Pic" />
            </div>
            <div className="w-full p-8">
              ...
              <div className="flex justify-between items-center mt-8">
                ...
                <div className="text-white p-8 rounded-full bg-red-500 shadow-lg">
                  {isPlaying ? (
                    <svg className="w-8 h-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" onClick={handlePlayPause}>
                      <path d="M5 4h3v12H5V4zm7 0h3v12h-3V4z" />
                    </svg>
                  ) : (
                    <svg className="w-8 h-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" onClick={handlePlayPause}>
                      <path d="M16 4v12l-8-6z" />
                    </svg>
                  )}
                </div>
                <div className="text-gray-700">
            ...
            <div className="mt-1">
              <div className="h-1 bg-gray-400 rounded-full">
                <div className="w-1/5 h-1 bg-red-300 rounded-full relative">
                  <span className="w-4 h-4 bg-red-500 absolute pin-r pin-b -mb-1 rounded-full shadow"></span>
                </div>
              </div>
            </div>
          </div>
